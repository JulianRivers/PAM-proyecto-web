# Generated by Django 4.1.2 on 2022-11-24 18:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plazo_inicio', models.DateField(verbose_name='plazo inicio')),
                ('plazo_final', models.DateField(verbose_name='plazo final')),
                ('url_prueba', models.CharField(max_length=250, verbose_name='url prueba')),
            ],
        ),
        migrations.CreateModel(
            name='Tipo_documento',
